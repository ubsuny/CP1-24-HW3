"""
Electric Force Calculation using Coulomb's Law

This module calculates the electric force between two point charges based on 
user input, using Coulomb's law.
"""
...
def main():
    """
    Main function to calculate and display the electric force between 
    two point charges using Coulomb's law.
    
    This function:
    1. Prompts the user to input the values of two charges (in microcoulombs) 
    and the distance between them (in centimeters).
